...
using hls::sim::Byte;
extern "C" void conv3x3_core(Byte<2>*, Byte<2>*, Byte<2>*);
extern "C" void apatb_conv3x3_core_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 102400;
...
__xlx_weights__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_weights)[i]);
  ...
  int __xlx_size_param_weights = 36864;
...
__xlx_output_r__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 102400;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*2;
  // DUT call
  conv3x3_core(__xlx_input_r__tmp_vec.data(), __xlx_weights__tmp_vec.data(), __xlx_output_r__tmp_vec.data());
