...
__attribute__((sdx_kernel("conv3x3_core", 0))) void conv3x3_core(
...
__attribute__((sdx_kernel("conv3x3_core", 0))) void conv3x3_core(
    ...
    const data_t weights[OUT_CHANNELS][IN_CHANNELS][KERNEL_SIZE][KERNEL_SIZE],
    data_t output[OUT_CHANNELS][IMAGE_HEIGHT][IMAGE_WIDTH]) {
#line 23 "D:/.YOLO_FPN_FPGA_Accelerator_Paper/07_experiments/stage2_hls_streaming_accelerator/conv3x3_core/conv3x3_core/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=conv3x3_core
# 23 "../conv3x3_core.cpp"

#line 6 "D:/.YOLO_FPN_FPGA_Accelerator_Paper/07_experiments/stage2_hls_streaming_accelerator/conv3x3_core/conv3x3_core/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=conv3x3_core
# 23 "../conv3x3_core.cpp"
...
#pragma HLS INLINE off
 ...
 VITIS_LOOP_29_1: for (int oc = 0; oc < OUT_CHANNELS; ++oc) {
        VITIS_LOOP_30_2: for (int row = 0; row < IMAGE_HEIGHT; ++row) {
            VITIS_LOOP_31_3: for (int col = 0; col < IMAGE_WIDTH; ++col) {
                double accumulator = 0.0;

                VITIS_LOOP_34_4: for (int ic = 0; ic < IN_CHANNELS; ++ic) {
                    VITIS_LOOP_35_5: for (int kr = 0; kr < KERNEL_SIZE; ++kr) {
                        VITIS_LOOP_36_6: for (int kc = 0; kc < KERNEL_SIZE; ++kc) {
