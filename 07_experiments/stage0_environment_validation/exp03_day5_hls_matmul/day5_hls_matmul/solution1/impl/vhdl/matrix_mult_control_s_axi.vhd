...
entity matrix_mult_control_s_axi is
generic (
...
end entity matrix_mult_control_s_axi;
...
architecture behave of matrix_mult_control_s_axi is
    ...
    constant ADDR_C_BASE  : INTEGER := 16#c0#;
    constant ADDR_C_HIGH  : INTEGER := 16#ff#;
    ...
    component matrix_mult_control_s_axi_ram is
        generic (
    ...
    end component matrix_mult_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_A
int_A : matrix_mult_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_A_q1);
-- int_B
int_B : matrix_mult_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
port map (
     ...
     q1        => int_B_q1);
-- int_C
int_C : matrix_mult_control_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "S2P",
     BYTES     => 4,
...
entity matrix_mult_control_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity matrix_mult_control_s_axi_ram;

architecture behave of matrix_mult_control_s_axi_ram is
